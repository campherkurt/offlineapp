...
(function() {
  ...
  var dateForImg = new Date();
  extendNative = function(to, from) {
      //console.log("In extend Native");
      //console.log(to);
      //console.log(from);
  ...
  Offline.checks.image = function() {
    ...
    img.src = Offline.getOption('checks.image.url') + "?version=" + dateForImg.getTime();
    return void 0;
  };
  ...
  Offline.onXHR = function(cb) {
    ...
    //console.log("Setting the xhr var");
    ...
    //console.log("Running the extend function");
    extendNative(window.XMLHttpRequest, _XMLHttpRequest);
    if (window.XDomainRequest != null) {
       //console.log("Checking XDomain");
  ...
  init = function() {
    ...
    if (Offline.getOption('interceptRequests')) {
        //console.log("Checing for interceopts= true");
